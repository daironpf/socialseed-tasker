...
from socialseed_tasker.bootstrap.wiring import Container as _Container
...
_container = _Container.from_env()


def get_repository() -> TaskRepositoryInterface:
    """Create and return the configured task repository.

    Intent: Provide the storage backend for CLI operations based on config.
    Business Value: Allows CLI to work with Neo4j or file storage.
    """
