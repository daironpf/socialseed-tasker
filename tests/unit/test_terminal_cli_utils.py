...
class TestCliUtilsModule:
    ...
    def test_load_saved_credentials_function_exists(self):
        ...
        from socialseed_tasker.entrypoints.terminal_cli.utils import load_saved_credentials
    ...
    def test_save_credentials_function_exists(self):
        ...
        from socialseed_tasker.entrypoints.terminal_cli.utils import save_credentials

        assert callable(save_credentials)

    def test_clear_credentials_function_exists(self):
        """Test clear_credentials function exists."""
        from socialseed_tasker.entrypoints.terminal_cli.utils import clear_credentials
    ...
    def test_get_config_file_path_function_exists(self):
        ...
        from socialseed_tasker.entrypoints.terminal_cli.utils import get_config_file_path
