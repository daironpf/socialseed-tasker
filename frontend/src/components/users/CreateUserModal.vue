...
const emit = defineEmits<{
  (e: 'close'): void
  (e: 'save', data: { username: string; email: string; role: string; type: string; avatar: string; skills: string[] }): void
}>()
...
function save() {
  ...
  form.value = { username: '', email: '', role: 'developer', type: 'human', avatar: '👤', skills: [] }
  close()
}
</script>
